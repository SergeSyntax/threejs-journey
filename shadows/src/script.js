...
directionalLight.shadow.radius = 10; // works with PCFShadowMap Algorithm add blur
...
const sphereShadow = new Mesh(
  ...
  new MeshBasicMaterial({ color: 0x000000, transparent: true, alphaMap: simpleShadow })
);
...
renderer.shadowMap.type = PCFSoftShadowMap; // the edge looks batter but you lose shadow blur
